...
<html>
  ...
  <body>
    ...
    <main>
      <div class="container">
        <h2 class="sub-title">カフェ管理トップ</h2>
        <div class="button-wrapper">
          <a class="button-secondary" href="../staff/staff_list.php">スタッフ管理</a>
          <a class="button-secondary" href="../product/product_list.php">商品管理</a>
        </div>
      </div>
    </main>
  </body>
